...
Preprocessing is another synthax for CSS written in a different language. 

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

My favorite concepts in preprocessing has to be variable because they save a lot of time and space while keeping your code tidy.

The concept that gave me the most trouble was the media queries I could not understand how to next them within a section of code. 


3. How would you explain the concept of a variable to someone new to programming?

A varable can be a style or format such as color being added to your css. If you are using the same color for different sections of text you can create a varaible that can be used for all the sections with the same color text. 


4. What is the purpose of using functions in code?

the purpose of using functions in code is that it rounds out the advance features of LESS and give developers even more tools to accomplish their goals in UI.


5. What is a JSON data?
Stands for Javascript Object Notation and it is a lightweight format for storing and transporting data. 
